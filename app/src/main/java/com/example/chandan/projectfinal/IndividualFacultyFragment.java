...
public class IndividualFacultyFragment extends Fragment {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {

        View v= inflater.inflate(R.layout.individual_faculty_notice,null);
...
//            progressDialog.show();
        ...
        StringRequest stringRequest = new StringRequest(
                Request.Method.POST,
                Constants.URL_GET_INDIVIDUAL_FACULTY_NOTICE,
...
//                            progressDialog.dismiss();
                        ...
                        try {
                            ...
                            if(j==1){
                                ...
                                View v=getView();
                                RecyclerView rv= (RecyclerView) v.findViewById(R.id.rvItemIndiFacultyNotice);
