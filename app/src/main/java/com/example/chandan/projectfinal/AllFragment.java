...
/**
 * Created by Chandan on 16-05-2017.
 */
...
public class AllFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            View v= inflater.inflate(R.layout.general_student_notice,null);
...
//                            progressDialog.dismiss();
                            ...
                            try {
                                ...
                                if(j==1){
                                    ...
                                    View v=getView();
                                    RecyclerView rv= (RecyclerView) v.findViewById(R.id.rvItemAllStudentNotice);
